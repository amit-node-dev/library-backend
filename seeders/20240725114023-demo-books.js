...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    const authorMap = {
      'Robert Kiyosaki': authors.find(a => a.email === 'tommy.helson@gmail.com')?.id,
      'Eric Ries': authors.find(a => a.email === 'rajveer@gmail.com')?.id,
      'Andy Weir': authors.find(a => a.email === 'emily.carter@example.com')?.id,
      'Alex Michaelides': authors.find(a => a.email === 'michael.zhang@example.com')?.id,
      'George Orwell': authors.find(a => a.email === 'sophia.r@example.com')?.id,
      'Yuval Noah Harari': authors.find(a => a.email === 'james.wilson@example.com')?.id,
      'Eric Carle': authors.find(a => a.email === 'olivia.m@example.com')?.id,
      'Robert C. Martin': authors.find(a => a.email === 'liam.j@example.com')?.id
    };
    

    // Fallback to random author if specific mapping not found
    const getAuthorId = (authorName) => {
      const result = authorMap[authorName] || authors[Math.floor(Math.random() * authors.length)].id;
      return result
    };
...
const getCategoryId = (categoryName) => {
  ...
  if (!category) {
    console.error(`Category not found: ${categoryName}, using first category as fallback`);
      ...
      [
        {
          ...
          description: "Robert Kiyosaki contrasts his two fathers - his real father (poor dad) and the father of his best friend (rich dad) - and how their differing attitudes about money, investing, and employment shaped his own financial philosophies.",
          conclusion: "Financial education is more valuable than job security alone.",
          isbn: "978-1612680194",
        ...
        },
        {
          ...
          conclusion: "Validated learning and rapid experimentation can reduce market risks.",
          isbn: "978-0307887894",
        ...
        },
        {
          ...
          conclusion: "Human ingenuity and cooperation can overcome seemingly impossible challenges.",
          isbn: "978-0593135204",
        ...
        },
        {
          ...
          description: "Alicia Berenson's life is seemingly perfect until one day her husband returns home and she shoots him five times in the face and then never speaks another word.",
          conclusion: "The human mind can create elaborate defenses to protect itself from trauma.",
          isbn: "978-1250301697",
        ...
        },
        {
          ...
          description: "Winston Smith toes the Party line, rewriting history to satisfy the demands of the Ministry of Truth. But when he's given a secret message from a rebel leader, he dares to imagine a different life.",
        ...
        },
        {
          ...
          conclusion: "Human cooperation and shared myths have been key to our species' success.",
          isbn: "978-0062316097",
          publisher: "Harper",
        ...
        },
        {
          ...
          title: "",
          description: "Follows the progress of a hungry little caterpillar as he eats his way through a varied and very large quantity of food until, full at last, he forms a cocoon around himself and goes to sleep.",
        ...
        },
        {
          ...
          description: "Even bad code can function. But if code isn't clean, it can bring a development organization to its knees. This book is a must for any developer, software engineer, or manager.",
          conclusion: "Writing clean code is a professional responsibility that pays long-term dividends.",
          isbn: "978-0132350884",
